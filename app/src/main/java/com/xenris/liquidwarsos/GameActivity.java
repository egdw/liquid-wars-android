            ...
            runOnUiThread(new Runnable() {
                ...
                public void run() {
                    ...
                    if(winningTeam == StaticBits.team)
                        ...
                        builder.setMessage(GameActivity.this.getResources().getString(R.string.Out_of_time)+ Util.teamToNameString(winningTeam) + GameActivity.this.getResources().getString(R.string.wins));
                    dialog = builder.show();
                ...
                runOnUiThread(new Runnable() {
                    ...
                    public void run() {
                        ...
                        if(p == StaticBits.team)
                            ...
                            builder.setMessage(Util.teamToNameString(p) + GameActivity.this.getResources().getString(R.string.wins));
                        dialog = builder.show();
                        TextView messageText = (TextView)dialog.findViewById(android.R.id.message);
                        messageText.setGravity(Gravity.CENTER);
