...
public class MultiplayerGameSetupActivity extends Activity implements OnItemSelectedListener, OnLongClickListener, Server.ServerCallbacks {
    ...
    public void changePublicName(View view) {
        ...
        new AlertDialog.Builder(this)
            .setTitle(R.string.Enter_a_name_to_identify_your_game)
            .setPositiveButton(R.string.Done, clicker)
    ...
    private void updateMessageTextView() {
        runOnUiThread(new Runnable() {
            ...
            public void run() {
                ...
                tv.setText(MultiplayerGameSetupActivity.this.getResources().getString(R.string.Sharing_game_on) + ssid + ". IP Address: " + ip + ". "+MultiplayerGameSetupActivity.this.getResources().getString(R.string.Number_of_players)+" " + (numberOfClients+1));
            }
        });
    }
