            ...
            runOnUiThread(new Runnable() {
                ...
                public void run() {
                    ...
                    if(winningTeam == StaticBits.team)
                        builder.setMessage(R.string.Out_of_time_You_win);
                    else
                        builder.setMessage(GameServerActivity.this.getResources().getString(R.string.Out_of_time) + Util.teamToNameString(winningTeam) + GameServerActivity.this.getResources().getString(R.string.wins));
                    dialog = builder.show();
                ...
                runOnUiThread(new Runnable() {
                    ...
                    public void run() {
                        ...
                        if(p == StaticBits.team)
                            ...
                            builder.setMessage(Util.teamToNameString(p) + GameServerActivity.this.getResources().getString(R.string.wins));
                        dialog = builder.show();
                        TextView messageText = (TextView)dialog.findViewById(android.R.id.message);
                        messageText.setGravity(Gravity.CENTER);
