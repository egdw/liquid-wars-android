...
public class MultiplayerMenuActivity extends Activity {
    ...
    public void connectToGame(View view) {
                ...
                public void onClick(DialogInterface dialog, int which) {
                    ...
                    if(which == DialogInterface.BUTTON_POSITIVE) {
                        ...
                        new AlertDialog.Builder(context)
                            ...
                            .setPositiveButton(R.string.Connect, clicker)
        ...
        searchAlertDialog = new AlertDialog.Builder(this)
            .setTitle(this.getResources().getString(R.string.Searching_on)+ ssid + "...")
            .setPositiveButton(R.string.Manual_Connect, clicker)
